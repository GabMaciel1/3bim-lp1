            ...
            switch (decisao) //no inicio de cada case, perguntar se ele quer voltar pro menu
            {
                ...
                case "2":
                    ...
                    for (int i = 0; i < qntdCadastros; i++)
                    {
                        ...
                        {
                            cadArray[i].info(); //decidi mostrar os vazios tambem, caso queira-se ocultá-los, basta deletar esta linha!
                        }
                ...
                case "4":
                    ...
                    if (confirmacao2 == "s" || confirmacao2 == "S")
                    {
                        ...
                        Console.WriteLine("------------------------------------------------------------------------------------------------------");
                        Console.Write("Tem certeza de que você quer exluir os dados de algum cadastro? Você não poderá voltar atrás! (s/n)...");
                        Console.WriteLine("------------------------------------------------------------------------------------------------------");
                        Console.Write("-->");
